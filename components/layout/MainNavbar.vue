  ...
  >
    <template slot-scope="{ toggle, isToggled }">
      <nuxt-link v-popover:popover1 class="navbar-brand" to="/">
        <img
          src="https://res.cloudinary.com/dgsljij3o/image/upload/v1621453357/image/ChildAbuseHelpLOGO_nesy3j.png "
          alt="logo"
          style="width: 150px; height: 150xp"
        />
      </nuxt-link>
      <el-popover
        ref="popover1"
        ...
        trigger="hover"
      >
        <div class="popover-body">Brought by &nbsp; NNECA</div>
      </el-popover>
    </template>
    <template slot="navbar-menu">
      ...
      <li class="nav-item">
        <a
          ...
          href="https://www.creative-tim.com/product/nuxt-now-ui-kit-pro"
          target="_blank"
        >
          <p>Buy Now</p>
        </a>
